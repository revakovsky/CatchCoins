...
class SharedPrefs(context: Context) {
    ...
    fun saveCurrentScore(currentScore: Int) {
        shPrefs.edit { putInt(SP_CURRENT_SCORE, currentScore) }
    }
    ...
    fun getMaxScore(): Int {
        return shPrefs.getInt(SP_MAX_SCORE, 0)
    }

    fun clearMaxScore() {
        shPrefs.edit { remove(SP_MAX_SCORE) }
    }
